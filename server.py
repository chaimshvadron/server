...
# **שימוש בגרסה מובנית של Chromium ב-Render**
...
def get_data_using_selenium():
    ...
    chrome_options.binary_location = CHROMIUM_PATH  # **שימוש בגרסה הקיימת ב-Render**
    ...
    service = Service(CHROMEDRIVER_PATH)  # **משתמש ב-ChromeDriver המובנה**
